package CalculatorBasic.Logica;
...
public class CalcLogic {
    ...
    public int checkIndexOperator(ArrayList<String> em, String o) {
        ArrayList<String> copyExpr = new ArrayList<String>(em);
        int index = -1;
    ...
    public ArrayList<String> calculator(ArrayList<String> em) {
        int indexOperator;
        ArrayList<String> ContMath = new ArrayList<String>(em);//{+ 8 / 0}
        ...
        while (ContMath.size() > 2) {
            if (operator.equalsIgnoreCase("/")) {
                ...
                if (indexOperator > -1) {
                    if(ContMath.get(0).equalsIgnoreCase("Infinity")){
                        ...
                        ContMath = new ArrayList<String>(calcMathDiv(ContMath, indexOperator));
                    }
                } else {
                    operator = "x";
                }
            ...
            if (operator.equalsIgnoreCase("x")) {
                ...
                if (indexOperator > -1) {
                    ContMath = new ArrayList<String>(calcMathProd(ContMath, indexOperator));
                } else {
                    operator = "+";
                }
            }
            ...
            if (operator.equalsIgnoreCase("+")) {
                ...
                if (indexOperator > -1) {
                    ContMath = new ArrayList<String>(calcMathAd(ContMath, indexOperator)); //{- 4 + 5},2
                } else {
                    operator = "-";
                }
            }
            ...
            if (operator.equalsIgnoreCase("-")) {
                indexOperator = checkIndexOperator(ContMath, "-");
                if (indexOperator > -1) {
                    ContMath = new ArrayList<String>(calcMathSus(ContMath, indexOperator)); //{- 3 - 3 - 3},2 ; {- [6] - 3},2
                }
            }
        }
        return ContMath;
